...
// Github - username
export const Github_UserName = "Sandhya";
export const Github_Repository_Name = "HungryGo";

// Github API for User
export const Github_API_User = "https://api.github.com/users/";

// Social Media Links
export const Linkedin_Link = "https://www.linkedin.com/in/sandhya-c-805289246/";
export const Github_Link = "https://github.com/SandhyaDevadiga";
export const Email_Link = "mailto:sandhyadevadiga8197@gmail.com";
